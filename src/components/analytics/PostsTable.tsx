              ...
              return (
                ...
                >
                  <td className="px-3 py-2.5">
                    <div className="w-14 h-14 rounded-lg bg-bg-elevated overflow-hidden flex items-center justify-center shrink-0">
                      {post.thumbnail ? (
                        <img
                          src={post.thumbnail}
                          alt=""
                  ...
                  <td className="px-3 py-2.5">
                    <p
                      className="text-[12px] text-text-primary truncate max-w-[220px]"
                      title={post.caption}
                    >
                      {caption}
                    </p>
