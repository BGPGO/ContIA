  ...
  if (success) {
    return (
      <motion.div
        ...
        className="bg-gradient-to-br from-[#0f1230] to-[#141736] border border-[#1e2348]/60 rounded-xl p-8 max-w-sm w-full text-center shadow-[0_0_40px_rgba(78,205,196,0.08)] relative overflow-hidden"
      >
        {/* Ambient glow orbs */}
